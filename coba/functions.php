...
function tambah($data) {
	...
	$query = "INSERT INTO percobaansatu VALUES
...
function hapus($id) {
	global $conn;
	mysqli_query($conn, "DELETE FROM percobaansatu WHERE id = $id");
	return mysqli_affected_rows($conn);
...
$query = "UPDATE percobaansatu SET
	nama = '$nama',
	alamat = '$alamat',
	notelp = '$notelp',
	email = '$email',
...
function cari($keyword){
	$query = "SELECT * FROM percobaansatu
				WHERE
